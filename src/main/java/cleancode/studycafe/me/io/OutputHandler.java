...
import cleancode.studycafe.me.model.PassOrder;
...
public class OutputHandler {
    ...
    public void showPassOrderSummary(PassOrder passOrder) {
        ...
        showPassInfo(passOrder);
        showLockerPassInfo(passOrder);
        showDiscountPriceInfo(passOrder);
        showTotalPriceInfo(passOrder);
    }

    private static void showTotalPriceInfo(PassOrder passOrder) {
        int totalPrice = passOrder.calculateTotalPrice();
        System.out.println("총 결제 금액: " + totalPrice + "원");
        System.out.println();
    }

    private static void showDiscountPriceInfo(PassOrder passOrder) {
    ...
    private static void showLockerPassInfo(PassOrder passOrder) {
        if (passOrder.isLockerPassPresent()) {
            System.out.println("사물함: " + passOrder.getLockerPassInfo());
        }
    }

    private static void showPassInfo(PassOrder passOrder) {
